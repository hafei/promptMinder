    ...
    try {
      ...
      if (!adminError && adminUser?.user) {
        return {
          ...
          display_name: adminUser.user.user_metadata?.display_name || adminUser.user.email?.split('@')[0],
          avatar_url: adminUser.user.user_metadata?.avatar_url,
          is_admin: adminUser.user.user_metadata?.is_admin || false
        }
      }
    } catch (adminError) {
