...
import { validateAPIKeyFormat, hasPermission, PERMISSIONS } from '@/lib/api-key-generator';
...
function extractAPIKey(req) {
  // Support both Next.js Pages API (plain object) and App Router (Headers instance)
