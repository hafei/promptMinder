...
export default function Footer({ t }) {
  const translations = t || {
    description: SITE_CONFIG.footerDescription,
    product: 'Product',
    roadmap: 'Roadmap',
    ...
    copyright: `© {year} ${SITE_CONFIG.appName}. All rights reserved`
  };
      ...
      <div className="max-w-7xl mx-auto pt-12 pb-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-4 pt-8">
          <p className="text-sm text-muted-foreground text-center">
            {translations.copyright.replace('{year}', currentYear.toString()).replace('PromptMinder', SITE_CONFIG.appName).replace('Prompt Minder', SITE_CONFIG.appName)}
          </p>
        </div>
      </div>
    </footer>
